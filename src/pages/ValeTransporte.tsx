...
import { Download, Save, Bus, Settings, Users, DollarSign, Building2, CreditCard, Upload, AlertCircle } from 'lucide-react';
...
export default function ValeTransporte() {
  ...
  const handleSaldoBlur = useCallback(async (row: typeof rows[0]) => {
    try {
      ...
      toast({ title: 'Saldo salvo', duration: 1500 });
    } catch {
      toast({ title: 'Erro ao salvar', variant: 'destructive' });
    }
  }, [upsertVt, toast, selectedMonth, selectedYear, session]);
